     ...
     <div id="main-wrapper">
        ...
        <% 
                ...
                delete_status=request.getParameter("delete_status");
                    ...
                    {            
                        x=stmt.executeUpdate("Delete from staff where name='"+dname+"'");
                    }
                }
        %>
...
Staff <%=dname%> deleted successfully !!
</div></th>>
...
<tr>
    ...
    <td><div align="center"><strong>Staff Name</strong></div></td>
...
<td><div align="center"><a href="update_staff.jsp?rname=<%=rs.getString("name")%>&rage=<%=rs.getString("age")%>&rmobile=<%=rs.getString("mobile")%>&raddress=<%=rs.getString("address")%>">Edit</a></div></td>
<td><div align="center"><a href="manage_staff.jsp?delete_status=yes&dname=<%=rs.getString("name")%>" onclick="return del()">Delete</a></div></td>
</tr>

<%
                    if(String.valueOf(session.getAttribute("addstaff")).equals("null"))
                    {}
                    
                    else
                    {
                    out.println(session.getAttribute("addstaff"));
                    session.removeAttribute("addstaff");
                    }
