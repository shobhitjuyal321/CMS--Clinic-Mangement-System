...
<body>    
    <div id="container-login">
        ...
        <form method="post">
            ...
            <div class="input">
                <input id="patname" placeholder="Patient name" name="patname" type="text" minlength="3" required class="validate" autocomplete="off">
            </div>

            <div class="clearfix"></div>

            <div class="input">
                <input id="age" placeholder="Age" type="text" name="age" maxlength="2" pattern="[0-9]{2}+[0-9]{1}" required class="validate" autocomplete="off">
            </div>
        ...
        <%                    
                ...
                try {
                        ...
                        if (email != null && age !=null && name !=null && mobile !=null && address !=null) {                            
