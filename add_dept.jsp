    ...
    <div class="preloader">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Doctors</h3> </div>
            ...
            <form>
                <center>
                    <h2><b>ADD DEPARTMENT</b></h2>
                    <table>     
                        
                    <tr><td><label><b>Department Name: </b></label>
                    <input type="text" name="dept_name" required size="35"></td></tr>
                    
                    <tr><td><button class="btn btn-info" type="submit">Submit</button>  
     ...
     <%
                        ...
                        try {
                            ...
                            query = "INSERT INTO department (dept_name) VALUES(?)";
                            PreparedStatement ps = (PreparedStatement) conn.prepareStatement(query);
                            ps.setString(1, name);                            
                            ps.executeUpdate();
                            session.setAttribute("adddept","Department "+name+" added successfully");
                            response.sendRedirect("add_dept.jsp");
                        } 
