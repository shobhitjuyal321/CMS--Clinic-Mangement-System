        ...
        <div class="page-wrapper">
            ...
            <form>
                <center>
                    ...
                    <tr><td><label id="staff_name" ><b>Staff Name: </b></label>
                    <input type="text" name="staff_name" required size="35"></td></tr>
...
<%
            try {
                        ...
                        Class.forName("com.mysql.jdbc.Driver");
                            ...
                            session.setAttribute("addstaff","Staff "+name+" added successfully");
                            response.sendRedirect("add_staff.jsp");
                        } 
