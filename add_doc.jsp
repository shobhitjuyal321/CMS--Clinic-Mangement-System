        ...
        <div class="page-wrapper">
            ...
            <form>
                <center>
                    ...
                    <tr><td><label id="doc_name" ><b>Doctor Name: </b></label>
                    <input type="text" name="doc_name" required size="35"></td></tr>
                    ...
                    <input type="text" name="mobile" required maxlength="10" minlength="10" pattern="[0-9]{10}" size="35" ><br></td></tr>
                    
                    <tr><td><label id="addr" ><b>Address: </b></label>
                    <input type="text" name="addr" size="35"><br><br></td></tr>
                    ...
                    <br>
                    <%
                    if(String.valueOf(session.getAttribute("adddoc")).equals("null"))
                    {}
                    
                    else
                    {
                    out.println(session.getAttribute("adddoc"));
                    session.removeAttribute("adddoc");
                    }
...
<%
            try {
                        ...
                        String spec = request.getParameter("dept");
                        ...
                        Class.forName("com.mysql.jdbc.Driver");
                            ...
                            while (rs.next()) {    
                                ...
                                if (name.equals(dname)) {                                    
                                    ...
                                    response.sendRedirect("add_doc.jsp");
                                }
                            }
                            
                            query = "INSERT INTO doctor VALUES(?,?,?,?,?,?,?,?,?,?)";
                            PreparedStatement ps = (PreparedStatement) conn.prepareStatement(query);
                            ps.setString(1, "doc_"+name);                                  
                            ps.setString(2, name);  
                            ...
                            ps.setString(10, "");
                            ps.executeUpdate();
                            session.setAttribute("adddoc","Doctor "+name+" added successfully");                            
                            response.sendRedirect("add_doc.jsp");
...
<%                    
                    ...
                    try
                        ...
                        RequestDispatcher rd=request.getRequestDispatcher("add_doc.jsp");                                
                        rd.forward(request, response);
                    }
