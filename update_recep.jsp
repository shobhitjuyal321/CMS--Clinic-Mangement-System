        ...
        <div class="page-wrapper">
            ...
            <form>
                <center>
                    ...
                    <input type="email" name="new_email" value="<%=request.getParameter("remail")%>" required id="new_email" class="validate" size="37" /></td></tr>  
                        ...
                        Class.forName("com.mysql.jdbc.Driver");
                            ...
                            while(rs.next()) { 
                                ...
                                if (name.equals(dcname)) {  
                                    ...
                                    response.sendRedirect("manage_recep.jsp");
                                }                            
                            
                            query = "UPDATE receptionist SET name=(?), email=(?), age=(?), mobile=(?), address=(?) WHERE name='"+rname+"'";
                            ...
                            session.setAttribute("update_r","Doctor "+rname+" Updated successfully");                            
                            response.sendRedirect("manage_recep.jsp");
