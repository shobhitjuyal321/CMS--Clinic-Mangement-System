     ...
     <div id="main-wrapper">
        ...
        <% 
                ...
                delete_status=request.getParameter("delete_status");
                    ...
                    {            
                        x=stmt.executeUpdate("Delete from doctor where name='"+dname+"'");
                    }
                }
        %>
...
Doctor <%=dname%> deleted successfully !!
</div></th>>
...
<tr>
    ...
    <td><div align="center"><strong>Doctor Name</strong></div></td>
...
<td><div align="center"><a href="update_doc.jsp?docname=<%=rs.getString("name")%>&docage=<%=rs.getString("age")%>&docmobile=<%=rs.getString("mobile")%>&docemail=<%=rs.getString("email")%>&docaddress=<%=rs.getString("address")%>">Edit</a></div></td>
<td><div align="center"><a href="manage_doc.jsp?delete_status=yes&dname=<%=rs.getString("name")%>" onclick="return del()">Delete</a></div></td>
</tr>
