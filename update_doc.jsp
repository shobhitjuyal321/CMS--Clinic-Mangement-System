        ...
        <div class="page-wrapper">
            ...
            <form>
                <center>
                    ...
                    <input type="hidden" id="docname" name="docname" value="<%=request.getParameter("docname")%>">
                    <input type="text" name="new_name" id="new_name" value="<%=request.getParameter("docname")%>" size="37" /></td></tr>   
                    
                    <tr><td><label><b>Change Age: </b></label>
                    <input type="text" name="new_age" value="<%=request.getParameter("docage")%>" maxlength="2" required id="new_age" size="37" /></td></tr>   
                    
                    <tr><td><label><b>Change Mobile: </b></label>
                    <input type="text" name="new_mobile" value="<%=request.getParameter("docmobile")%>" minlength="10" maxlength="10" pattern="[0-9]{10}" required id="new_mobile" size="37" /></td></tr>                       
                    
                    <tr><td><label><b>Change Email: </b></label>
                    <input type="email" name="new_email" value="<%=request.getParameter("docemail")%>" required id="new_email" class="validate" size="37" /></td></tr>  
                    
                    <tr><td><label><b>Change Address: </b></label>
                    <input type="text" name="new_addr" value="<%=request.getParameter("docaddress")%>" required id="new_addr" size="37" /></td></tr>   
                        ...
                        Class.forName("com.mysql.jdbc.Driver");
                            ...
                            while(rs.next()) { 
                                ...
                                if (name.equals(dcname)) {  
                                    session.setAttribute("already","doctor "+name+" already Exists");
                                    response.sendRedirect("manage_doc.jsp");
                                }
                                                 
                            query = "UPDATE doctor SET name=(?), email=(?), age=(?), mobile=(?), address=(?) WHERE name='"+docname+"'";
                            ...
                            session.setAttribute("adddoc","Doctor "+docname+" Updated successfully");                            
                            response.sendRedirect("manage_doc.jsp");                            
                        }                
                }                         
                catch (Exception ex) {
