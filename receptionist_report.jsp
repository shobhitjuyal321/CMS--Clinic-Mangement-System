...
%>                                
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Dashboard</h3> Welcome <%=session.getAttribute("uname")%> </div>
            ...
            <div class="container-fluid">
                ...
                <tr>
                    ...
                    <td><div align="center" name="dname"><strong>Payment</strong></div></td>  
                </tr>
        <%   
                int icount=0;                
                try{
                ...
                PreparedStatement stmt = con.prepareStatement("select name from patient where description!='' and paid=0");
                ResultSet rs=stmt.executeQuery();
                //out.println(stmt.executeQuery("select dept_name from department where doctor='"+session.getAttribute("uname")+"'"));
                while(rs.next()){
                {
        ...
        %>
                ...
                <tr>
                    ...
                    <td><div align="center"><a href="JavaScript:newPopup('receptionist_payment.jsp?patname=<%=rs.getString("name")%>');">Report</a></div></td>
                </tr>
        ...
        %> 
                ...
                <center>
                <%
                    if(String.valueOf(session.getAttribute("report")).equals("null"))
                    {}
