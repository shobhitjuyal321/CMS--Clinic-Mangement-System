...
%>
        ...
        <div class="page-wrapper">
            ...
            function cancel()
            {
                ...
                <%
                    ...
                    {            
                        x=stmt2.executeUpdate("update patient set description='Appointment Canceled', cost=0, paid=0 where name='"+dname+"'");
                    }
                %>
                ...
                %> 
                <tr>
                <th height="35" colspan="9"><div align="center"> Patient <%=dname%> Appointment Canceled successfully !! </div></th>
                <%  }   %>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><div  align="center" ><strong>Treatment</strong></div></td>
        <%                
                try{
                ...
                PreparedStatement stmt3 = con.prepareStatement("select name from doctor where username=?");
                stmt3.setString(1,session.getAttribute("uname").toString());
                ResultSet rs3=stmt3.executeQuery();  
                
                while(rs3.next()){
                    String doc=rs3.getString("name"); 
        ...
        <%   
                ...
                PreparedStatement stmt = con.prepareStatement("select * from department where doctor='"+doc+"'");
                ResultSet rs=stmt.executeQuery();                
                while(rs.next()){
                    int results = 0;
                    String dept=rs.getString("dept_name");
                    stmt = con.prepareStatement("select * from patient where clinic='"+dept+"' and description=''");
        ...
        %>
                ...
                <tr>
                    ...
                    <td><div align="center"><h2><%=rs.getString("name")%></h2></div></td>                    
                    <td><div align="center"><a href="doctor_manage.jsp?delete_status=yes&dname=<%=rs.getString("name")%>" onclick="return cancel()">Cancel</a></div></td>
                    <td><div align="center"><a href="doctor_appoint.jsp?dname=<%=rs.getString("name")%>">Review</a></div></td>
                </tr>
                
                    <%}
                    if(results == 0) {
                            out.print("<h2>No patient left for Appointment.<h2>");
                            }
                    else{
                            out.print("<h2>Patient Left for Appointment.<h2>");
                            }
                    %>
