     ...
     <div id="main-wrapper">
        ...
        <% 
                ...
                delete_status=request.getParameter("delete_status");
                    ...
                    {            
                        x=stmt.executeUpdate("Delete from receptionist where name='"+dname+"'");
                    }
                }
        %>
...
Receptionist <%=dname%> deleted successfully !!
</div></th>>
...
<tr>
    ...
    <td><div align="center"><strong>Receptionist Name</strong></div></td>
...
<td><div align="center"><a href="update_recep.jsp?rname=<%=rs.getString("name")%>&remail=<%=rs.getString("email")%>&rage=<%=rs.getString("age")%>&rmobile=<%=rs.getString("mobile")%>&raddress=<%=rs.getString("address")%>">Edit</a></div></td>
<td><div align="center"><a href="manage_recep.jsp?delete_status=yes&dname=<%=rs.getString("name")%>" onclick="return del()">Delete</a></div></td>
</tr>

<%
                    if(String.valueOf(session.getAttribute("update_r")).equals("null"))
                    {}
                    
                    else
                    {
                    out.println(session.getAttribute("update_r"));
                    session.removeAttribute("update_r");
                    }
